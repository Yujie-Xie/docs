...
## Character sets and collations supported by TiDB {#character-sets-and-collations-supported-by-tidb}
...
## <code>utf8</code> and <code>utf8mb4</code> in TiDB {#code-utf8-code-and-code-utf8mb4-code-in-tidb}
...
## Character set and collation in different layers {#character-set-and-collation-in-different-layers}
...
### String character sets and collation {#string-character-sets-and-collation}
...
## Collation support framework {#collation-support-framework}
...
### Old framework for collations {#old-framework-for-collations}
...
### New framework for collations {#new-framework-for-collations}
...
## Coercibility values of collations in expressions {#coercibility-values-of-collations-in-expressions}
...
## <code>COLLATE</code> clause {#code-collate-code-clause}
