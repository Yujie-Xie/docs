...
# Best Practices for TiDB Security Configuration {#best-practices-for-tidb-security-configuration}
...
## Set the initial password for the root user {#set-the-initial-password-for-the-root-user}
...
## Enable password complexity checks {#enable-password-complexity-checks}
...
## Change the default Grafana password {#change-the-default-grafana-password}
...
## Enhance TiDB Dashboard security {#enhance-tidb-dashboard-security}

### Use a least privilege user {#use-a-least-privilege-user}
...
### Restrict access control {#restrict-access-control}
...
## Protect internal ports {#protect-internal-ports}
...
## Resolving false positives from third-party MySQL vulnerability scanners {#resolving-false-positives-from-third-party-mysql-vulnerability-scanners}
