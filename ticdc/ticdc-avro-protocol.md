...
| TINYBLOB   | BLOB      | bytes     | <li></li>                                                                                                                  |
| BLOB       | BLOB      | bytes     | <li></li>                                                                                                                  |
| MEDIUMBLOB | BLOB      | bytes     | <li></li>                                                                                                                  |
| LONGBLOB   | BLOB      | bytes     | <li></li>                                                                                                                  |
| BINARY     | BLOB      | bytes     | <li></li>                                                                                                                  |
| VARBINARY  | BLOB      | bytes     | <li></li>                                                                                                                  |
| TINYTEXT   | TEXT      | string    | <li></li>                                                                                                                  |
| TEXT       | TEXT      | string    | <li></li>                                                                                                                  |
| MEDIUMTEXT | TEXT      | string    | <li></li>                                                                                                                  |
| LONGTEXT   | TEXT      | string    | <li></li>                                                                                                                  |
| CHAR       | TEXT      | string    | <li></li>                                                                                                                  |
| VARCHAR    | TEXT      | string    | <li></li>                                                                                                                  |
| FLOAT      | FLOAT     | double    | <li></li>                                                                                                                  |
| DOUBLE     | DOUBLE    | double    | <li></li>                                                                                                                  |
| DATE       | DATE      | string    | <li></li>                                                                                                                  |
| DATETIME   | DATETIME  | string    | <li></li>                                                                                                                  |
| TIMESTAMP  | TIMESTAMP | string    | <li></li>                                                                                                                  |
| TIME       | TIME      | string    | <li></li>                                                                                                                  |
| YEAR       | YEAR      | int       | <li></li>                                                                                                                  |
| BIT        | BIT       | bytes     | <li></li>                                                                                                                  |
| JSON       | JSON      | string    | <li></li>                                                                                                                  |
| ENUM       | ENUM      | string    | <li></li>                                                                                                                  |
| SET        | SET       | string    | <li></li>                                                                                                                  |
...
### Distinguish event types {#distinguish-event-types}
