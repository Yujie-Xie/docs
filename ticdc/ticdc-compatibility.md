...
# TiCDC Compatibility {#ticdc-compatibility}

This section describes compatibility issues related to TiCDC and how to handle them.

## Compatibility with TiDB Lightning {#compatibility-with-tidb-lightning}
...
## Compatibility with TiFlash {#compatibility-with-tiflash}
...
## CLI and configuration file compatibility {#cli-and-configuration-file-compatibility}
...
## Handle compatibility issues {#handle-compatibility-issues}
