...
# TiCDC Simple Protocol {#ticdc-simple-protocol}
...
## Use the TiCDC Simple protocol {#use-the-ticdc-simple-protocol}
...
## Message generation and sending rules {#message-generation-and-sending-rules}
...
## Message consumption methods {#message-consumption-methods}
...
### Scenario 1: The consumer starts consuming from the beginning {#scenario-1-the-consumer-starts-consuming-from-the-beginning}
...
### Scenario 2: The consumer starts consuming from the middle {#scenario-2-the-consumer-starts-consuming-from-the-middle}
...
### TableSchema definition {#tableschema-definition}
...
### mysqlType reference table {#mysqltype-reference-table}
