...
# TiDB Best Practices {#tidb-best-practices}
...
Starting from TiDB 4.0, TiDB provides [TiDB Dashboard](/dashboard/dashboard-intro.md) UI to improve usability. You can access TiDB Dashboard by visiting [http://${PD_IP}:${PD_PORT}/dashboard](http://$%7BPD_IP%7D:$%7BPD_PORT%7D/dashboard) in your browser. TiDB Dashboard provides features such as viewing cluster status, performance analysis, traffic visualization, cluster diagnostics, and log searching.
