...
## TiFlash encryption at rest {#tiflash-encryption-at-rest}
...
## BR Azure Blob Storage server-side encryption {#br-azure-blob-storage-server-side-encryption}
...
### Method 1: use an encryption scope {#method-1-use-an-encryption-scope}
...
### Method 2: use an encryption key {#method-2-use-an-encryption-key}
