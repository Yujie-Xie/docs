...
## System tables related to PLAN REPLAYER {#system-tables-related-to-plan-replayer}
...
## System tables related to runaway queries {#system-tables-related-to-runaway-queries}
...
## System tables related to DDL statements {#system-tables-related-to-ddl-statements}
...
## System tables related to TiDB Distributed eXecution Framework (DXF) {#system-tables-related-to-tidb-distributed-execution-framework-dxf}
...
## System tables related to Resource Control {#system-tables-related-to-resource-control}
