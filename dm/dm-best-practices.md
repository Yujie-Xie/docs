...
# TiDB Data Migration (DM) Best Practices {#tidb-data-migration-dm-best-practices}
...
## Before data migration {#before-data-migration}
...
### Best practices for the business side {#best-practices-for-the-business-side}
...
#### Business impact of AUTO_INCREMENT in schema design {#business-impact-of-auto-increment-in-schema-design}
...
#### Usage of clustered indexes {#usage-of-clustered-indexes}
...
### Key points for MySQL shards {#key-points-for-mysql-shards}
...
#### The pessimistic mode and the optimistic mode {#the-pessimistic-mode-and-the-optimistic-mode}
...
### Other restrictions and impact {#other-restrictions-and-impact}

#### Data types in upstream and downstream {#data-types-in-upstream-and-downstream}
...
#### Deploy DM-master and DM-worker {#deploy-dm-master-and-dm-worker}
...
#### Plan the migration tasks {#plan-the-migration-tasks}
...
#### Choose and configure the upstream data source {#choose-and-configure-the-upstream-data-source}
...
### Details of configurations {#details-of-configurations}
...
#### Use the relay log {#use-the-relay-log}
...
#### Use PT-osc/GH-ost in upstream {#use-pt-osc-gh-ost-in-upstream}
...
## Best practices during migration {#best-practices-during-migration}

This section introduces how to troubleshoot problems you might encounter during migration.

### Inconsistent schemas in upstream and downstream {#inconsistent-schemas-in-upstream-and-downstream}
...
### Interrupted migration task due to failed DDL {#interrupted-migration-task-due-to-failed-ddl}
...
## Data validation after data migration {#data-validation-after-data-migration}
...
## Long-term data replication {#long-term-data-replication}
