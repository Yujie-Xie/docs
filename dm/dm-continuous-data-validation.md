...
# Continuous Data Validation in DM {#continuous-data-validation-in-dm}
...
## Enable continuous data validation {#enable-continuous-data-validation}
...
### Method 1: Enable in the task configuration file {#method-1-enable-in-the-task-configuration-file}
...
### Method 2: Enable using dmctl {#method-2-enable-using-dmctl}
...
## Use continuous data validation {#use-continuous-data-validation}
...
### View the validation status {#view-the-validation-status}
...
### Handle error rows {#handle-error-rows}
...
## Stop continuous data validation {#stop-continuous-data-validation}
...
## Set the cutover point for continuous data validation {#set-the-cutover-point-for-continuous-data-validation}
