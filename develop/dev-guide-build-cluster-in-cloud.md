...
# Build a TiDB Cloud Serverless Cluster {#build-a-tidb-cloud-serverless-cluster}
...
## Step 1. Create a TiDB Cloud Serverless cluster {#step-1-create-a-tidb-cloud-serverless-cluster}
