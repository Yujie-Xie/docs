...
# TiDB Optimistic Transaction Model {#tidb-optimistic-transaction-model}
...
## Principles of optimistic transactions {#principles-of-optimistic-transactions}
...
### Limits of retry {#limits-of-retry}
