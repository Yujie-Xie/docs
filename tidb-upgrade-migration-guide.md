...
# Migrate and Upgrade a TiDB Cluster {#migrate-and-upgrade-a-tidb-cluster}
...
## Step 1: Evaluate solution feasibility {#step-1-evaluate-solution-feasibility}
...
## Step 2: Prepare the new cluster {#step-2-prepare-the-new-cluster}

### 1. Adjust the GC lifetime of the old cluster {#1-adjust-the-gc-lifetime-of-the-old-cluster}
...
### 2. Migrate full data to the new cluster {#2-migrate-full-data-to-the-new-cluster}
...
### 3. Upgrade the new cluster to the target version {#3-upgrade-the-new-cluster-to-the-target-version}
...
## Step 3: Replicate incremental data {#step-3-replicate-incremental-data}

### 1. Establish a forward data replication channel {#1-establish-a-forward-data-replication-channel}
...
### 2. Verify data consistency {#2-verify-data-consistency}
...
### 3. Finalize the environment setup {#3-finalize-the-environment-setup}
...
## Step 4: Switch business traffic and rollback {#step-4-switch-business-traffic-and-rollback}

### 1. Prepare for the switchover {#1-prepare-for-the-switchover}
...
### 2. Execute the switchover {#2-execute-the-switchover}
...
### 3. Execute emergency rollback {#3-execute-emergency-rollback}
