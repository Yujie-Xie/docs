...
# TiDB Dashboard Diagnostic Report {#tidb-dashboard-diagnostic-report}
...
#### Diagnostics Time Range {#diagnostics-time-range}
...
#### Cluster Hardware Info {#cluster-hardware-info}
...
#### Cluster Topology Info {#cluster-topology-info}
...
#### TiKV Thread CPU Usage {#tikv-thread-cpu-usage}
...
#### Time Consumed by Each Component {#time-consumed-by-each-component}
...
#### Errors Occurred in Each Component {#errors-occurred-in-each-component}
...
#### Specific TiDB/PD/TiKV monitoring information {#specific-tidb-pd-tikv-monitoring-information}

This part includes more specific monitoring information of TiDB, PD, or TiKV.

#### TiDB-related monitoring information {#tidb-related-monitoring-information}

##### Time Consumed by TiDB Component {#time-consumed-by-tidb-component}
...
##### TiDB Server Connections {#tidb-server-connections}

This table shows the number of client connections for each TiDB instance.

##### TiDB Transaction {#tidb-transaction}
...
#### PD related monitoring information {#pd-related-monitoring-information}
...
#### TiKV related monitoring information {#tikv-related-monitoring-information}
...
### DIFF_RATIO introduction {#diff-ratio-introduction}
...
### Maximum Different Item table {#maximum-different-item-table}
