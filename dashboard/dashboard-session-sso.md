...
# Configure SSO for TiDB Dashboard {#configure-sso-for-tidb-dashboard}
...
### Re-enter the password after a password change {#re-enter-the-password-after-a-password-change}
...
## Sign in via SSO {#sign-in-via-sso}
...
## Example 1: Use Okta for TiDB Dashboard SSO sign-in {#example-1-use-okta-for-tidb-dashboard-sso-sign-in}
...
### Step 2: Obtain OIDC information and fill in TiDB Dashboard {#step-2-obtain-oidc-information-and-fill-in-tidb-dashboard}
...
## Example 2: Use Auth0 for TiDB Dashboard SSO sign-in {#example-2-use-auth0-for-tidb-dashboard-sso-sign-in}
...
## Example 3: Use Casdoor for TiDB Dashboard SSO sign-in {#example-3-use-casdoor-for-tidb-dashboard-sso-sign-in}
...
### Step 1: Configure Casdoor {#step-1-configure-casdoor}

1.  Deploy and access the Casdoor administration site.

2.  Navigate from the top sidebar **Applications**.

3.  Click **Applications - Add**. ![Settings](/media/dashboard/dashboard-session-sso-casdoor-settings-1.png)
