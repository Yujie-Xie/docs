...
## Unsupported security features {#unsupported-security-features}
...
## Differences with MySQL {#differences-with-mysql}
...
### Password failure tracking {#password-failure-tracking}
