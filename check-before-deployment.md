...
## Set temporary spaces for TiDB instances (Recommended) {#set-temporary-spaces-for-tidb-instances-recommended}
...
## Check the firewall service of target machines {#check-the-firewall-service-of-target-machines}
...
### Change the firewall zone {#change-the-firewall-zone}
