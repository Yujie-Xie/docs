...
### Create a table with clustered indexes {#create-a-table-with-clustered-indexes}
...
### Add or drop clustered indexes {#add-or-drop-clustered-indexes}
...
### Add or drop non-clustered indexes {#add-or-drop-non-clustered-indexes}
...
### Check whether the primary key is a clustered index {#check-whether-the-primary-key-is-a-clustered-index}
...
### Compatibility with earlier and later TiDB versions {#compatibility-with-earlier-and-later-tidb-versions}
...
### Compatibility with other TiDB features {#compatibility-with-other-tidb-features}
