...
# Migrate and Merge MySQL Shards of Large Datasets to TiDB Cloud {#migrate-and-merge-mysql-shards-of-large-datasets-to-tidb-cloud}
...
## Environment information in the example {#environment-information-in-the-example}
...
## Perform full data migration from MySQL to TiDB Cloud {#perform-full-data-migration-from-mysql-to-tidb-cloud}
...
### Step 1. Create directories in the Amazon S3 bucket {#step-1-create-directories-in-the-amazon-s3-bucket}
...
### Step 2. Use Dumpling to export data to Amazon S3 {#step-2-use-dumpling-to-export-data-to-amazon-s3}
...
### Step 3. Create schemas in TiDB Cloud cluster {#step-3-create-schemas-in-tidb-cloud-cluster}
...
### Step 4. Configure Amazon S3 access {#step-4-configure-amazon-s3-access}
...
### Step 5. Perform the data import task {#step-5-perform-the-data-import-task}
...
## Perform incremental data replication from MySQL to TiDB Cloud {#perform-incremental-data-replication-from-mysql-to-tidb-cloud}
...
### Step 1. Add the data source {#step-1-add-the-data-source}
...
### Step 2. Create a replication task {#step-2-create-a-replication-task}
...
### Step 3. Start the replication task {#step-3-start-the-replication-task}
...
### Step 4. Check the replication task status {#step-4-check-the-replication-task-status}
