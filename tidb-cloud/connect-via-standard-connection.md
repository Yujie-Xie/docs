...
# Connect to TiDB Cloud Dedicated via Public Connection {#connect-to-tidb-cloud-dedicated-via-public-connection}
...
## Prerequisite: Configure IP access list {#prerequisite-configure-ip-access-list}
