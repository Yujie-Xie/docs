...
1.  Click <mdsvgicon name="icon-top-organization"> in the lower-left corner of the TiDB Cloud console.</mdsvgicon>
...
1.  In the lower-left corner of the [TiDB Cloud console](https://tidbcloud.com), click <mdsvgicon name="icon-top-organization">, and then click **Billing**.</mdsvgicon>
...
To view or update the billing profile of your organization, click <mdsvgicon name="icon-top-organization"> in the lower-left corner and then click **Billing** > **Billing Profile**.</mdsvgicon>
...
## Billing from AWS Marketplace, Azure Marketplace, or Google Cloud Marketplace {#billing-from-aws-marketplace-azure-marketplace-or-google-cloud-marketplace}
