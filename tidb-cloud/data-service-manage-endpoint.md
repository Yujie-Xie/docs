...
### Generate an endpoint automatically {#generate-an-endpoint-automatically}
...
### Create an endpoint manually {#create-an-endpoint-manually}
...
### Add a predefined system endpoint {#add-a-predefined-system-endpoint}
...
## Develop an endpoint {#develop-an-endpoint}
...
## Undeploy an endpoint {#undeploy-an-endpoint}
