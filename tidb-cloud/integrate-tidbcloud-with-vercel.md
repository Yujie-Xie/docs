...
# Integrate TiDB Cloud with Vercel {#integrate-tidb-cloud-with-vercel}
...
### A Vercel account and a Vercel project {#a-vercel-account-and-a-vercel-project}
...
### A Data App and endpoints {#a-data-app-and-endpoints}
...
### Connect with TiDB Cloud Serverless branching {#connect-with-tidb-cloud-serverless-branching}
...
## Connect via manually setting environment variables {#connect-via-manually-setting-environment-variables}
