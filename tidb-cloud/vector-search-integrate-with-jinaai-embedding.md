...
# Integrate TiDB Vector Search with Jina AI Embeddings API {#integrate-tidb-vector-search-with-jina-ai-embeddings-api}
...
### Get embeddings from Jina AI {#get-embeddings-from-jina-ai}
...
### Connect to the TiDB cluster {#connect-to-the-tidb-cluster}
...
### Define the vector table schema {#define-the-vector-table-schema}
...
### Create embeddings with Jina AI and store in TiDB {#create-embeddings-with-jina-ai-and-store-in-tidb}
...
### Perform semantic search with Jina AI embeddings in TiDB {#perform-semantic-search-with-jina-ai-embeddings-in-tidb}
