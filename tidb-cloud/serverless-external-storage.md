...
# Configure External Storage Access for TiDB Cloud Serverless {#configure-external-storage-access-for-tidb-cloud-serverless}
...
## Configure Alibaba Cloud Object Storage Service (OSS) access {#configure-alibaba-cloud-object-storage-service-oss-access}
