...
# Integrate TiDB Cloud with New Relic (Beta) {#integrate-tidb-cloud-with-new-relic-beta}
...
### Step 1. Integrate with your New Relic API Key {#step-1-integrate-with-your-new-relic-api-key}
...
### Step 2. Add TiDB Cloud Dashboard in New Relic {#step-2-add-tidb-cloud-dashboard-in-new-relic}
...
## Metrics available to New Relic {#metrics-available-to-new-relic}
