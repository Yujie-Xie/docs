...
# Migrate Cluster Resource to Serverless or Dedicated Cluster Resource {#migrate-cluster-resource-to-serverless-or-dedicated-cluster-resource}
...
## Step 1. Identify the <code>tidbcloud_cluster</code> resource to migrate {#step-1-identify-the-code-tidbcloud-cluster-code-resource-to-migrate}
...
## Step 2. Remove the existing resource from the Terraform state {#step-2-remove-the-existing-resource-from-the-terraform-state}
...
## Step 3. Delete the configuration of your target cluster resource {#step-3-delete-the-configuration-of-your-target-cluster-resource}

In your `.tf` file, find the configuration of your target cluster resource and delete the corresponding code.

## Step 4. Add an import block for the new serverless or dedicated cluster resource {#step-4-add-an-import-block-for-the-new-serverless-or-dedicated-cluster-resource}
...
## Step 5. Generate the new configuration file {#step-5-generate-the-new-configuration-file}
...
## Step 6. Review and apply the generated configuration {#step-6-review-and-apply-the-generated-configuration}
