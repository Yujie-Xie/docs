...
### TiDB Cloud user accounts {#tidb-cloud-user-accounts}
...
### Database user accounts {#database-user-accounts}
...
### SQL Proxy accounts {#sql-proxy-accounts}
...
### TiDB privileges and roles {#tidb-privileges-and-roles}
...
### Identity and Access Management (IAM) Roles {#identity-and-access-management-iam-roles}

TiDB Cloud provides role-based access control to manage permissions across organizations and projects:

-   **<a href="/tidb-cloud/manage-user-access.md#organization-roles">Organization-Level roles</a>**: Grant permissions to manage the entire organization, including billing and project creation.

-   **<a href="/tidb-cloud/manage-user-access.md#project-roles">Project-Level roles</a>**: Assign permissions to manage specific projects, including clusters and configurations.
