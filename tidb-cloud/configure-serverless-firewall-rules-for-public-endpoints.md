...
# Configure TiDB Cloud Serverless Firewall Rules for Public Endpoints {#configure-tidb-cloud-serverless-firewall-rules-for-public-endpoints}
...
### Characteristics of public access {#characteristics-of-public-access}
...
### Allow AWS access {#allow-aws-access}
...
## Create and manage a firewall rule {#create-and-manage-a-firewall-rule}
