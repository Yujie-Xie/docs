...
# TiDB Cloud Built-in Metrics {#tidb-cloud-built-in-metrics}
...
## View the Metrics page {#view-the-metrics-page}
...
## Metrics retention policy {#metrics-retention-policy}

For TiDB Cloud Dedicated clusters and TiDB Cloud Serverless clusters, the metrics data is kept for 7 days.

## Metrics for TiDB Cloud Dedicated clusters {#metrics-for-tidb-cloud-dedicated-clusters}
...
## Metrics for TiDB Cloud Serverless clusters {#metrics-for-tidb-cloud-serverless-clusters}
