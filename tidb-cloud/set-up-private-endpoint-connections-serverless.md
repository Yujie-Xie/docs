...
# Connect to TiDB Cloud Serverless via Private Endpoint {#connect-to-tidb-cloud-serverless-via-private-endpoint}
...
## Set up a private endpoint with AWS {#set-up-a-private-endpoint-with-aws}
...
### Step 1. Choose a TiDB cluster {#step-1-choose-a-tidb-cluster}
...
### Step 3: Connect to your TiDB cluster {#step-3-connect-to-your-tidb-cluster}
