...
-   Enhance the [System Status](https://status.tidbcloud.com/) page to provide better insights into TiDB Cloud system health and performance.
    ...
    To access it, visit [https://status.tidbcloud.com/](https://status.tidbcloud.com/) directly, or navigate via the [TiDB Cloud console](https://tidbcloud.com) by clicking **?** in the lower-right corner and selecting **System Status**.
