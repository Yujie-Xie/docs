...
# TLS Connections to TiDB Cloud Dedicated {#tls-connections-to-tidb-cloud-dedicated}
...
## Secure connection to a TiDB Cloud Dedicated cluster {#secure-connection-to-a-tidb-cloud-dedicated-cluster}
...
## Manage root certificates for TiDB Cloud Dedicated {#manage-root-certificates-for-tidb-cloud-dedicated}
...
### Which TLS versions are supported to connect to my TiDB Cloud Dedicated cluster? {#which-tls-versions-are-supported-to-connect-to-my-tidb-cloud-dedicated-cluster}
...
### Is two-way TLS authentication between my client and TiDB Cloud Dedicated supported? {#is-two-way-tls-authentication-between-my-client-and-tidb-cloud-dedicated-supported}
