...
# Troubleshoot Access Denied Errors during Data Import from Amazon S3 {#troubleshoot-access-denied-errors-during-data-import-from-amazon-s3}
...
## Cannot assume the provided role {#cannot-assume-the-provided-role}
...
### Check the trust entity {#check-the-trust-entity}
...
### Check whether the IAM role exists {#check-whether-the-iam-role-exists}
...
### Check whether the external ID is set correctly {#check-whether-the-external-id-is-set-correctly}
...
### Check the policy of the IAM user {#check-the-policy-of-the-iam-user}
...
### Check the policy of the IAM role {#check-the-policy-of-the-iam-role}
...
### Check the bucket policy {#check-the-bucket-policy}
...
### Check the Object Ownership {#check-the-object-ownership}
...
### Check your bucket encryption type {#check-your-bucket-encryption-type}
...
### Check the AWS article for instruction {#check-the-aws-article-for-instruction}
