...
# Migrate MySQL-Compatible Databases to TiDB Cloud Using Data Migration {#migrate-mysql-compatible-databases-to-tidb-cloud-using-data-migration}
...
### Maximum number of migration jobs {#maximum-number-of-migration-jobs}
...
### Filtered out and deleted databases {#filtered-out-and-deleted-databases}
...
### Limitations of existing data migration {#limitations-of-existing-data-migration}
...
### Limitations of incremental data migration {#limitations-of-incremental-data-migration}
...
### Make sure your data source and version are supported {#make-sure-your-data-source-and-version-are-supported}
...
### Enable binary logs in the source MySQL-compatible database for replication {#enable-binary-logs-in-the-source-mysql-compatible-database-for-replication}
...
#### Check current values and configure the source MySQL instance {#check-current-values-and-configure-the-source-mysql-instance}
...
#### End-to-end encryption over TLS/SSL {#end-to-end-encryption-over-tls-ssl}
...
#### Public endpoints or IP addresses {#public-endpoints-or-ip-addresses}
...
#### Private link or private endpoint {#private-link-or-private-endpoint}
...
### Grant required privileges for migration {#grant-required-privileges-for-migration}
...
#### Grant required privileges to the migration user in the source MySQL database {#grant-required-privileges-to-the-migration-user-in-the-source-mysql-database}
...
## Step 2: Configure the source and target connections {#step-2-configure-the-source-and-target-connections}
...
## Step 3: Choose migration job type {#step-3-choose-migration-job-type}

In the **Choose the objects to be migrated** step, you can choose existing data migration, incremental data migration, or both.

### Migrate existing data and incremental data {#migrate-existing-data-and-incremental-data}
...
### Migrate only existing data {#migrate-only-existing-data}
...
### Migrate only incremental data {#migrate-only-incremental-data}
...
## Step 4: Choose the objects to be migrated {#step-4-choose-the-objects-to-be-migrated}
...
## Step 5: Precheck {#step-5-precheck}
...
## Step 6: Choose a spec and start migration {#step-6-choose-a-spec-and-start-migration}
...
## Step 7: View the migration progress {#step-7-view-the-migration-progress}
...
## Scale a migration job specification {#scale-a-migration-job-specification}
