...
### Grant required privileges to the upstream database {#grant-required-privileges-to-the-upstream-database}
...
### Grant required privileges to the downstream TiDB Cloud cluster {#grant-required-privileges-to-the-downstream-tidb-cloud-cluster}
...
### Set up network connection {#set-up-network-connection}
...
## Step 2: Configure the source and target connection {#step-2-configure-the-source-and-target-connection}
