...
# Export Data from TiDB Cloud Serverless {#export-data-from-tidb-cloud-serverless}
...
### Export data to a local file {#export-data-to-a-local-file}
...
### Export data to Amazon S3 {#export-data-to-amazon-s3}
...
### Export data to Azure Blob Storage {#export-data-to-azure-blob-storage}
...
### Export data to Alibaba Cloud OSS {#export-data-to-alibaba-cloud-oss}
