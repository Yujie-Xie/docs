...
# Connect to a TiDB Cloud Dedicated Cluster via Azure Private Link {#connect-to-a-tidb-cloud-dedicated-cluster-via-azure-private-link}
...
## Set up a private endpoint with Azure Private Link {#set-up-a-private-endpoint-with-azure-private-link}
...
### Step 2. Create an Azure private endpoint {#step-2-create-an-azure-private-endpoint}
...
### Step 3. Accept the endpoint {#step-3-accept-the-endpoint}
...
### If I cancel the action during setup, what should I do before accepting the private endpoint? {#if-i-cancel-the-action-during-setup-what-should-i-do-before-accepting-the-private-endpoint}
