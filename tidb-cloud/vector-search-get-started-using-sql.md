...
# Get Started with Vector Search via SQL {#get-started-with-vector-search-via-sql}
...
### Step 1. Connect to the TiDB cluster {#step-1-connect-to-the-tidb-cluster}
...
### Step 2. Create a vector table {#step-2-create-a-vector-table}
...
### Step 3. Insert vector embeddings to the table {#step-3-insert-vector-embeddings-to-the-table}
...
### Step 4. Query the vector table {#step-4-query-the-vector-table}
...
### Step 5. Perform a vector search query {#step-5-perform-a-vector-search-query}
