...
# Connect to TiDB Cloud Serverless with WordPress {#connect-to-tidb-cloud-serverless-with-wordpress}
...
## Run WordPress with TiDB Cloud Serverless {#run-wordpress-with-tidb-cloud-serverless}

This section demonstrates how to run WordPress with TiDB Cloud Serverless.

### Step 1: Clone the WordPress sample repository {#step-1-clone-the-wordpress-sample-repository}
...
### Step 4: Start WordPress with TiDB Cloud Serverless {#step-4-start-wordpress-with-tidb-cloud-serverless}
...
### Step 5: Confirm the database connection {#step-5-confirm-the-database-connection}
