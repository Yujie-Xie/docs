...
# Connect to TiDB Cloud Serverless via Public Endpoint {#connect-to-tidb-cloud-serverless-via-public-endpoint}
...
## Connect via a public endpoint {#connect-via-a-public-endpoint}
...
## Disable a public endpoint {#disable-a-public-endpoint}
