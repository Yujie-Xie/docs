...
# TiDB Cloud Performance Highlights for TiDB v8.5.0 {#tidb-cloud-performance-highlights-for-tidb-v8-5-0}
...
## Hotspot reads with excessive MVCC versions {#hotspot-reads-with-excessive-mvcc-versions}
...
## IO latency jitter {#io-latency-jitter}
...
## TiKV scaling performance {#tikv-scaling-performance}
