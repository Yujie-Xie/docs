...
# Subscribe via Zoom {#subscribe-via-zoom}
...
## Subscribe to alert notifications {#subscribe-to-alert-notifications}

### Step 1. Add the Zoom Incoming Webhook app {#step-1-add-the-zoom-incoming-webhook-app}
...
### Step 2. Generate a Zoom webhook URL {#step-2-generate-a-zoom-webhook-url}
...
### Step 3. Subscribe from TiDB Cloud {#step-3-subscribe-from-tidb-cloud}
...
1.  Click <mdsvgicon name="icon-left-projects"> in the lower-left corner, switch to the target project if you have multiple projects, and then click **Project Settings**.</mdsvgicon>
...
## Unsubscribe from alert notifications {#unsubscribe-from-alert-notifications}
