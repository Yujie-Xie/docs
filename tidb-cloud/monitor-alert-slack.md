...
# Subscribe via Slack {#subscribe-via-slack}
...
### Step 1. Generate a Slack webhook URL {#step-1-generate-a-slack-webhook-url}
...
### Step 2. Subscribe from TiDB Cloud {#step-2-subscribe-from-tidb-cloud}
