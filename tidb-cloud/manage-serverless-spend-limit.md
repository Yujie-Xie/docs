...
# Manage Spending Limit for TiDB Cloud Serverless Scalable Clusters {#manage-spending-limit-for-tidb-cloud-serverless-scalable-clusters}
...
## Update spending limit {#update-spending-limit}
