...
# Vector Search Integration Overview {#vector-search-integration-overview}
...
## Embedding models and services {#embedding-models-and-services}
...
## Object Relational Mapping (ORM) libraries {#object-relational-mapping-orm-libraries}
