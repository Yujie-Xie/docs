...
# TiDB Cloud Serverless Driver Prisma Tutorial {#tidb-cloud-serverless-driver-prisma-tutorial}
...
## Enable <code>driverAdapters</code> {#enable-code-driveradapters-code}
...
## Use the Prisma adapter in Node.js environments {#use-the-prisma-adapter-in-node-js-environments}
