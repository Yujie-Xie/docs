...
# Get Started with Data Service {#get-started-with-data-service}
...
## Get started with a sample Data App {#get-started-with-a-sample-data-app}
...
## Get started with your own Data App {#get-started-with-your-own-data-app}
...
### Step 1. Create a Data App {#step-1-create-a-data-app}
...
### Step 2. Develop an endpoint {#step-2-develop-an-endpoint}
...
#### Write SQL statements {#write-sql-statements}
...
### Step 3. Test the endpoint (optional) {#step-3-test-the-endpoint-optional}
...
### Step 4. Deploy the endpoint {#step-4-deploy-the-endpoint}
...
### Step 5. Call the endpoint {#step-5-call-the-endpoint}
...
#### 2. Get the code example {#2-get-the-code-example}
...
#### 3. Use the code example {#3-use-the-code-example}
