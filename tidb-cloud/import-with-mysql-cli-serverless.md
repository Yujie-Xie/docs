...
# Import Data into TiDB Cloud Serverless via MySQL CLI {#import-data-into-tidb-cloud-serverless-via-mysql-cli}
...
## Step 1. Connect to your TiDB Cloud Serverless cluster {#step-1-connect-to-your-tidb-cloud-serverless-cluster}
...
## Step 2. Define the table and insert sample data {#step-2-define-the-table-and-insert-sample-data}
...
## Step 3. Import data from a SQL or CSV file {#step-3-import-data-from-a-sql-or-csv-file}
