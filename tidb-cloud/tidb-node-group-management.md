...
# Manage TiDB Node Groups {#manage-tidb-node-groups}
...
## Create a TiDB node group {#create-a-tidb-node-group}
...
## Connect to a TiDB node group {#connect-to-a-tidb-node-group}

### Connect via public connection {#connect-via-public-connection}
...
### Connect via private endpoint {#connect-via-private-endpoint}
...
## View TiDB node groups {#view-tidb-node-groups}
...
## Modify a TiDB node group {#modify-a-tidb-node-group}
...
## Delete a TiDB node group {#delete-a-tidb-node-group}
