...
# Integrate TiDB Cloud Serverless with Amazon Lambda Using AWS CloudFormation {#integrate-tidb-cloud-serverless-with-amazon-lambda-using-aws-cloudformation}
...
## Step 1. Set up the bookshop project using AWS CloudFormation {#step-1-set-up-the-bookshop-project-using-aws-cloudformation}
...
## Step 2. Use the bookshop project {#step-2-use-the-bookshop-project}
