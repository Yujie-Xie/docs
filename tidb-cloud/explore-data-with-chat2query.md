...
# Explore Your Data with AI-Assisted SQL Editor {#explore-your-data-with-ai-assisted-sql-editor}
...
## Access SQL Editor {#access-sql-editor}
...
## Enable or disable AI to generate SQL queries {#enable-or-disable-ai-to-generate-sql-queries}
...
-   To disable AI, click <mdsvgicon name="icon-top-account-settings"> in the lower-left corner of the [TiDB Cloud console](https://tidbcloud.com/), click **Account Settings**, click the **AI &#x26; Privacy** tab, and then disable the **AI-powered Data Exploration** option.</mdsvgicon>

## Write and run SQL queries {#write-and-run-sql-queries}
...
## Rewrite SQL queries using Chat2Query {#rewrite-sql-queries-using-chat2query}
...
## Manage SQL files {#manage-sql-files}
...
## Access Chat2Query via API {#access-chat2query-via-api}
...
## Generate an endpoint from a SQL file {#generate-an-endpoint-from-a-sql-file}
...
## Manage SQL Editor settings {#manage-sql-editor-settings}
