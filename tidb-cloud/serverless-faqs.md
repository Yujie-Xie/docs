...
# TiDB Cloud Serverless FAQs {#tidb-cloud-serverless-faqs}
...
### What is TiDB Cloud Serverless? {#what-is-tidb-cloud-serverless}
...
### How do I get started with TiDB Cloud Serverless? {#how-do-i-get-started-with-tidb-cloud-serverless}

Get started with the 5-minute [TiDB Cloud Quick Start](/tidb-cloud/tidb-cloud-quickstart.md).

### How many TiDB Cloud Serverless clusters can I create in TiDB Cloud? {#how-many-tidb-cloud-serverless-clusters-can-i-create-in-tidb-cloud}
...
### Are all TiDB Cloud features fully supported on TiDB Cloud Serverless? {#are-all-tidb-cloud-features-fully-supported-on-tidb-cloud-serverless}
...
### When will TiDB Cloud Serverless be available on cloud platforms other than AWS, such as Google Cloud or Azure? {#when-will-tidb-cloud-serverless-be-available-on-cloud-platforms-other-than-aws-such-as-google-cloud-or-azure}
...
### I created a Developer Tier cluster before TiDB Cloud Serverless was available. Can I still use my cluster? {#i-created-a-developer-tier-cluster-before-tidb-cloud-serverless-was-available-can-i-still-use-my-cluster}
...
### What is columnar storage in TiDB Cloud Serverless? {#what-is-columnar-storage-in-tidb-cloud-serverless}
...
### When should I use columnar storage in TiDB Cloud Serverless? {#when-should-i-use-columnar-storage-in-tidb-cloud-serverless}
...
### How to use columnar storage in TiDB Cloud Serverless? {#how-to-use-columnar-storage-in-tidb-cloud-serverless}
...
## Billing and metering FAQs {#billing-and-metering-faqs}

### What are Request Units? {#what-are-request-units}
...
### Is there any free plan available for TiDB Cloud Serverless? {#is-there-any-free-plan-available-for-tidb-cloud-serverless}
...
### What are the limitations of the free plan? {#what-are-the-limitations-of-the-free-plan}
...
### How can I estimate the number of RUs required by my workloads and plan my monthly budget? {#how-can-i-estimate-the-number-of-rus-required-by-my-workloads-and-plan-my-monthly-budget}
...
### How can I optimize my workload to minimize the number of RUs consumed? {#how-can-i-optimize-my-workload-to-minimize-the-number-of-rus-consumed}
...
### How storage is metered for TiDB Cloud Serverless？ {#how-storage-is-metered-for-tidb-cloud-serverless}
...
### Why does the storage usage size remain unchanged after dropping a table or database immediately? {#why-does-the-storage-usage-size-remain-unchanged-after-dropping-a-table-or-database-immediately}
...
### Why are there RU consumptions when I'm not actively running any queries? {#why-are-there-ru-consumptions-when-i-m-not-actively-running-any-queries}
...
### Why is there a spike in RU usage when my workload is steady? {#why-is-there-a-spike-in-ru-usage-when-my-workload-is-steady}
...
### What happens when my cluster exhausts its free quota or exceeds its spending limit? {#what-happens-when-my-cluster-exhausts-its-free-quota-or-exceeds-its-spending-limit}
...
### Why do I observe spikes in RU usage while importing data? {#why-do-i-observe-spikes-in-ru-usage-while-importing-data}
...
### What costs are involved when using columnar storage in TiDB Cloud Serverless? {#what-costs-are-involved-when-using-columnar-storage-in-tidb-cloud-serverless}
...
### Is using columnar storage more expensive? {#is-using-columnar-storage-more-expensive}
...
### Is my TiDB Cloud Serverless shared or dedicated? {#is-my-tidb-cloud-serverless-shared-or-dedicated}
...
### How does TiDB Cloud Serverless ensure security? {#how-does-tidb-cloud-serverless-ensure-security}
...
## Maintenance FAQ {#maintenance-faq}

### Can I upgrade the version of TiDB that my cluster is running on? {#can-i-upgrade-the-version-of-tidb-that-my-cluster-is-running-on}
