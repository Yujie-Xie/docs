...
# Import Data into TiDB Cloud Dedicated via MySQL CLI {#import-data-into-tidb-cloud-dedicated-via-mysql-cli}
...
## Step 1. Connect to your TiDB Cloud Dedicated cluster {#step-1-connect-to-your-tidb-cloud-dedicated-cluster}
