...
# Integrate Vector Search with LangChain {#integrate-vector-search-with-langchain}
...
### Step 1. Create a new Jupyter Notebook file {#step-1-create-a-new-jupyter-notebook-file}
...
### Step 4. Load the sample document {#step-4-load-the-sample-document}

#### Step 4.1 Download the sample document {#step-4-1-download-the-sample-document}
...
#### Step 4.2 Load and split the document {#step-4-2-load-and-split-the-document}
...
### Step 5. Embed and store document vectors {#step-5-embed-and-store-document-vectors}
...
### Step 6. Perform a vector search {#step-6-perform-a-vector-search}
...
#### Option 1: Use <code>similarity_search_with_score()</code> {#option-1-use-code-similarity-search-with-score-code}
...
#### Option 2: Use <code>similarity_search_with_relevance_scores()</code> {#option-2-use-code-similarity-search-with-relevance-scores-code}
...
### Use as a retriever {#use-as-a-retriever}
...
### Remove the vector store {#remove-the-vector-store}
...
## Search with metadata filters {#search-with-metadata-filters}
...
### Metadata filter syntax {#metadata-filter-syntax}
...
## Advanced usage example: travel agent {#advanced-usage-example-travel-agent}
...
### Retrieve detailed airport information {#retrieve-detailed-airport-information}
