...
# Migrate from MySQL-Compatible Databases to TiDB Cloud Using AWS DMS {#migrate-from-mysql-compatible-databases-to-tidb-cloud-using-aws-dms}
...
## Step 1. Create an AWS DMS replication instance {#step-1-create-an-aws-dms-replication-instance}
...
## Step 2. Create the source database endpoint {#step-2-create-the-source-database-endpoint}
...
## Step 3. Create the target database endpoint {#step-3-create-the-target-database-endpoint}
...
## Step 4. Create a database migration task {#step-4-create-a-database-migration-task}
