...
# Integrate TiDB Vector Search with Amazon Bedrock {#integrate-tidb-vector-search-with-amazon-bedrock}
...
### Step 1. Set the environment variables {#step-1-set-the-environment-variables}
...
### Step 2. Set up the Python virtual environment {#step-2-set-up-the-python-virtual-environment}
...
### Step 3. Import required libraries {#step-3-import-required-libraries}
...
### Step 6. Create a vector table {#step-6-create-a-vector-table}
...
### Step 7. Save the vector data to TiDB Cloud Serverless {#step-7-save-the-vector-data-to-tidb-cloud-serverless}
