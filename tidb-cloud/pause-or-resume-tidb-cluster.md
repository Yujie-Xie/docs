...
# Pause or Resume a TiDB Cloud Dedicated Cluster {#pause-or-resume-a-tidb-cloud-dedicated-cluster}
...
## Pause a TiDB cluster {#pause-a-tidb-cluster}
...
## Resume a TiDB cluster {#resume-a-tidb-cluster}
