...
### TiDB vCPU and RAM {#tidb-vcpu-and-ram}
...
### TiDB node count {#tidb-node-count}
...
### TiKV vCPU and RAM {#tikv-vcpu-and-ram}
...
### TiKV node count {#tikv-node-count}
...
#### Estimate TiKV node count according to data volume {#estimate-tikv-node-count-according-to-data-volume}
...
#### Estimate TiKV node count according to expected performance {#estimate-tikv-node-count-according-to-expected-performance}
...
### TiKV node storage size {#tikv-node-storage-size}
...
### TiKV node storage types {#tikv-node-storage-types}
...
### TiFlash vCPU and RAM {#tiflash-vcpu-and-ram}
...
### TiFlash node count {#tiflash-node-count}
...
### TiFlash node storage {#tiflash-node-storage}
...
### TiFlash node storage types {#tiflash-node-storage-types}
