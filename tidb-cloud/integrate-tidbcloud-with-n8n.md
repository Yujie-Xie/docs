...
# Integrate TiDB Cloud with n8n {#integrate-tidb-cloud-with-n8n}
...
## Prerequisites: Get TiDB Cloud API key {#prerequisites-get-tidb-cloud-api-key}

1.  Access your TiDB Cloud dashboard.
2.  Click <mdsvgicon name="icon-top-organization">, and then click **Organization Settings** in the lower-left corner.</mdsvgicon>
...
## Step 1: Install n8n {#step-1-install-n8n}
...
## Step 2: Install TiDB Cloud node in n8n {#step-2-install-tidb-cloud-node-in-n8n}
...
## Step 3: Build your workflow {#step-3-build-your-workflow}
...
### (Optional) Create a TiDB Cloud Serverless cluster {#optional-create-a-tidb-cloud-serverless-cluster}
...
#### Use a manual trigger as the workflow's starter {#use-a-manual-trigger-as-the-workflow-s-starter}
...
#### Create a table used to insert data {#create-a-table-used-to-insert-data}
...
#### Get the Hacker News RSS {#get-the-hacker-news-rss}
...
#### Insert data to TiDB {#insert-data-to-tidb}
...
#### Send message by Gmail {#send-message-by-gmail}
...
## Step 4: Run your workflow {#step-4-run-your-workflow}
...
## TiDB Cloud node core {#tidb-cloud-node-core}
