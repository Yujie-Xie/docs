...
# SQL Tuning Overview {#sql-tuning-overview}
...
## Tune SQL performance {#tune-sql-performance}
...
### Use Statement on the Diagnosis page {#use-statement-on-the-diagnosis-page}
...
### Optimize the execution plan {#optimize-the-execution-plan}
...
### Optimize full table scan {#optimize-full-table-scan}
...
### DML best practices {#dml-best-practices}

See [DML best practices](/develop/dev-guide-optimize-sql-best-practices.md#dml-best-practices).

### DDL best practices when selecting primary keys {#ddl-best-practices-when-selecting-primary-keys}
