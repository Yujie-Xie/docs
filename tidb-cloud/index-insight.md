...
### Step 1: Enable Index Insight {#step-1-enable-index-insight}
...
### Step 2: Manually trigger Index Insight {#step-2-manually-trigger-index-insight}
...
### Step 3: View index recommendations {#step-3-view-index-recommendations}
...
### Step 4: Implement index recommendations {#step-4-implement-index-recommendations}
...
### Regularly trigger Index Insight {#regularly-trigger-index-insight}
...
### Analyze impact before implementing indexes {#analyze-impact-before-implementing-indexes}
...
### How to deactivate Index Insight? {#how-to-deactivate-index-insight}
...
### How to delete the SQL user after deactivating Index Insight? {#how-to-delete-the-sql-user-after-deactivating-index-insight}
...
### Why does the <code>invalid user or password</code> message show up during activation or check-up? {#why-does-the-code-invalid-user-or-password-code-message-show-up-during-activation-or-check-up}
...
### Why does the <code>no sufficient privileges</code> message show up during activation or check-up? {#why-does-the-code-no-sufficient-privileges-code-message-show-up-during-activation-or-check-up}
...
### Why does the <code>operations may be too frequent</code> message show up during using Index Insight? {#why-does-the-code-operations-may-be-too-frequent-code-message-show-up-during-using-index-insight}
...
### Why does the <code>internal error</code> message show up during using Index Insight? {#why-does-the-code-internal-error-code-message-show-up-during-using-index-insight}
