...
# Set Up Self-Hosted Kafka Private Link Service in Azure {#set-up-self-hosted-kafka-private-link-service-in-azure}
...
#### 1. Set up the Kafka virtual network {#1-set-up-the-kafka-virtual-network}
