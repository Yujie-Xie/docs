...
## Create the HNSW vector index {#create-the-hnsw-vector-index}
...
## Use the vector index {#use-the-vector-index}
...
## Use the vector index with filters {#use-the-vector-index-with-filters}
...
## View index build progress {#view-index-build-progress}
...
## Check whether the vector index is used {#check-whether-the-vector-index-is-used}
...
## Analyze vector search performance {#analyze-vector-search-performance}
