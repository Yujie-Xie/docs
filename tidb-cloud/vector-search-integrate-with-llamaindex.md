...
# Integrate Vector Search with LlamaIndex {#integrate-vector-search-with-llamaindex}
...
#### Step 4.2 Load the document {#step-4-2-load-the-document}
...
#### Step 5.1 Initialize the TiDB vector store {#step-5-1-initialize-the-tidb-vector-store}
...
#### Step 5.2 Generate and store embeddings {#step-5-2-generate-and-store-embeddings}
...
### Step 7. Search with metadata filters {#step-7-search-with-metadata-filters}
...
#### Query with <code>book != "paul_graham"</code> filter {#query-with-code-book-paul-graham-code-filter}
...
### Step 8. Delete documents {#step-8-delete-documents}
