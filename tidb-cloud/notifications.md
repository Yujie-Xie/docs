...
# Notifications in the TiDB Cloud Console {#notifications-in-the-tidb-cloud-console}
...
Alternatively, click <mdsvgicon name="icon-top-account-settings"> in the lower-left corner of the TiDB Cloud console, and then click **Notifications** to view a list of all notifications, where you can click a specific notification for more details.</mdsvgicon>
