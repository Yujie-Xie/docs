...
# Integrate TiDB Cloud Serverless Branching (Beta) with GitHub {#integrate-tidb-cloud-serverless-branching-beta-with-github}
...
## Integrate TiDB Cloud Serverless branching with your GitHub repository {#integrate-tidb-cloud-serverless-branching-with-your-github-repository}
...
## TiDB Cloud Branching app behaviors {#tidb-cloud-branching-app-behaviors}
...
## Configure TiDB Cloud Branching app {#configure-tidb-cloud-branching-app}
...
## Create a branching CI workflow {#create-a-branching-ci-workflow}
