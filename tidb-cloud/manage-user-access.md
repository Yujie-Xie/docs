...
### View and switch between organizations {#view-and-switch-between-organizations}
...
### Set the time zone for your organization {#set-the-time-zone-for-your-organization}
...
### Modify organization roles {#modify-organization-roles}
...
### View and switch between projects {#view-and-switch-between-projects}
...
### Modify project roles {#modify-project-roles}
...
1.  In the [TiDB Cloud console](https://tidbcloud.com), click <mdsvgicon name="icon-top-account-settings"> in the lower-left corner.</mdsvgicon>
