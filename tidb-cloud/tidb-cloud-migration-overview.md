...
# Migration and Import Overview {#migration-and-import-overview}
...
## Import data from files to TiDB Cloud {#import-data-from-files-to-tidb-cloud}
...
### Configure cloud storage access {#configure-cloud-storage-access}
...
### Naming conventions for data import {#naming-conventions-for-data-import}
