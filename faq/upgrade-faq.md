...
# Upgrade and After Upgrade FAQs {#upgrade-and-after-upgrade-faqs}

This document introduces some FAQs and their solutions when or after you upgrade TiDB.

## Upgrade FAQs {#upgrade-faqs}

This section lists some FAQs and their solutions when you upgrade TiDB.

### What are the effects of rolling updates? {#what-are-the-effects-of-rolling-updates}
...
### Can I upgrade the TiDB cluster during the DDL execution? {#can-i-upgrade-the-tidb-cluster-during-the-ddl-execution}
...
### How to upgrade TiDB using the binary? {#how-to-upgrade-tidb-using-the-binary}
...
## After upgrade FAQs {#after-upgrade-faqs}

This section lists some FAQs and their solutions after you upgrade TiDB.

### The collation in JDBC connections changes after upgrading TiDB {#the-collation-in-jdbc-connections-changes-after-upgrading-tidb}
...
### The character set (charset) errors when executing DDL operations {#the-character-set-charset-errors-when-executing-ddl-operations}
