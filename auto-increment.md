...
### Cache size control {#cache-size-control}
...
### Clear the auto-increment ID cache {#clear-the-auto-increment-id-cache}
...
### Auto-increment step size and offset {#auto-increment-step-size-and-offset}
