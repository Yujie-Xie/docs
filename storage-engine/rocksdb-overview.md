...
## RocksDB memory usage {#rocksdb-memory-usage}
...
## RocksDB space usage {#rocksdb-space-usage}
...
## RocksDB background threads and compaction {#rocksdb-background-threads-and-compaction}
