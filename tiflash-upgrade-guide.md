...
# TiFlash Upgrade Guide {#tiflash-upgrade-guide}
...
## Upgrade TiFlash using TiUP {#upgrade-tiflash-using-tiup}
...
## From 5.x or v6.0 to v6.1 {#from-5-x-or-v6-0-to-v6-1}
...
## From v5.x or v6.0 to v6.2 {#from-v5-x-or-v6-0-to-v6-2}
...
## From v6.1 to v6.2 {#from-v6-1-to-v6-2}
...
## From v6.x or v7.x to v7.3 with <code>storage.format_version = 5</code> configured {#from-v6-x-or-v7-x-to-v7-3-with-code-storage-format-version-5-code-configured}
...
## From v6.x or v7.x to v7.4 or a later version {#from-v6-x-or-v7-x-to-v7-4-or-a-later-version}
