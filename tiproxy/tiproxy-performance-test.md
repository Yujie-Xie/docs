...
# TiProxy Performance Test Report {#tiproxy-performance-test-report}
...
#### TiProxy configuration {#tiproxy-configuration}
...
#### HAProxy configuration - <code>haproxy.cfg</code> file {#haproxy-configuration-code-haproxy-cfg-code-file}
...
## Basic workload test {#basic-workload-test}
...
## Result set test {#result-set-test}
...
## Long connection test {#long-connection-test}
...
## Short connection test {#short-connection-test}
