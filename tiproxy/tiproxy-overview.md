...
# TiProxy Overview {#tiproxy-overview}
...
### Modify TiProxy configuration {#modify-tiproxy-configuration}
...
### Upgrade TiProxy {#upgrade-tiproxy}
...
### Restart the TiDB cluster {#restart-the-tidb-cluster}
...
## TiProxy resources {#tiproxy-resources}
