...
# Snapshot Backup and Restore Guide {#snapshot-backup-and-restore-guide}
...
## Get the backup time point of a snapshot backup {#get-the-backup-time-point-of-a-snapshot-backup}
...
### Performance and impact of snapshot backup {#performance-and-impact-of-snapshot-backup}
...
### Performance and impact of snapshot restore {#performance-and-impact-of-snapshot-restore}
