...
#### Backup performance and impact on TiDB clusters {#backup-performance-and-impact-on-tidb-clusters}
...
#### BR version compatibility matrix before TiDB v6.6.0 {#br-version-compatibility-matrix-before-tidb-v6-6-0}
...
#### BR version compatibility matrix between TiDB v6.5.0 and v8.1.0 {#br-version-compatibility-matrix-between-tidb-v6-5-0-and-v8-1-0}
...
| v7.1.0         | <li></li>                   | v7.5.0 and later              |
| v7.5.0         | v7.5.0 and later            | <li></li>                     |
| v8.1.0         | v8.1.0 and later            | <li></li>                     |
